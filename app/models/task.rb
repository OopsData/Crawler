...
class Task
  ...
  TIEBA_HASH = {
    "我们15个" => {name:"我们15个",link:"http://tieba.baidu.com/f?kw=%E6%88%91%E4%BB%AC15%E4%B8%AA&ie=utf-8&pn=0",max_pn:36000},
    "真正男子汉" => {name:"真正男子汉",link:"http://tieba.baidu.com/f?kw=%E7%9C%9F%E6%AD%A3%E7%94%B7%E5%AD%90%E6%B1%89&ie=utf-8&pn=0",max_pn:11000},
    "奇葩说" => {name:"奇葩说",link:"http://tieba.baidu.com/f?kw=%E5%A5%87%E8%91%A9%E8%AF%B4&ie=utf-8&pn=0",max_pn:13000},
    "爸爸去哪2" => {name:"爸爸去哪2",link:"http://tieba.baidu.com/f?kw=%E7%88%B8%E7%88%B8%E5%8E%BB%E5%93%AA%E5%84%BF&ie=utf-8&pn=0",max_pn:160000},
  ...
  def self.runing_tieba_history_tasks(spn,hash)
    max_pn    = hash[:max_pn]
    threads   = []
    (spn..max_pn).each_slice(500) do |pn_arr|
      threads << Thread.new {
        spn   = pn_arr.first 
        epn   = pn_arr.last 
        name  = hash[:name]
