...
class TiebaTheme
  ...
  #我们15个预警关键词
  WARN1 = %w(卸载 假 没意思 无语 无聊 看不了 怎么回事 APP 声音 不真实 导播 偏离 没看懂 慢 恶搞 剧本 受骗 违约 失望 质疑 作秀 农村 完蛋 中断 差 散漫 消极 负能量 演 删 停播 外援 外挂 开挂)
  #我们15个卷入关键词
  ENTANGLE1 = %w(真实 生活 实验 发展 团结 创造 资源 理想 信任 合作 生存 财富 钱 创新 理念 重建 探索 坚持 规则 淘汰 精神 理解 负责 渴望 回归 自然 提高 直播 参加 报名 劳动 体验 指挥 经济 规划 矛盾 假 没意思 剧本 质疑 作秀 失望 不真实 赞 棒 喜欢 支持 舒服 吐槽 演 挑拨 商业)
  #我们15个节目关键词
  PROGRAM = %w(真实 生活 实验 发展 团结 创造 资源 理想 信任 合作 生存 财富 钱 创新 理念 重建 探索 坚持 规则 淘汰 精神 理解 负责 渴望 回归 自然 提高 直播 参加 报名 劳动 体验 指挥 经济 规划 矛盾 正能量 环境 梦想 追求 建设 未来 价值 改变 商业) 
  #我们15个剧情关键词
  STORY   = %w(吴进强 谈判 合作 箱包 协商 拳赛 拳王赛 月月鸟 画中画 荷花 比赛 拳击赛 旅馆 洗衣 洗头 做饭 唱歌 耕地 种菜 电脑 马桶 奶牛 设计 牛奶 耕地 表演 电话 生理 粮食 食物 造型 厨房 卫生巾 灶台 煮饭 野菜 铁锹 卫生 木头 开垦 石头 怀孕 木板 床 洗澡 种植 教练 饮食 牛 奶瓶 煤气罐 雨 牛粪 吵架 早饭 撕逼 补充 洗澡 有水军 解锁 钓鱼 粪池 破产 欠钱 粮食 牛粪 培训 招学员 手机 绝食 病 姿势 违规 皮具 工艺品 农场主 红薯 哭 皮制品 沈老板 洗白 许巍 歌曲 烧饭 偷吃 外挂 项链 湿疹 脏话 骂人 退出 回归 手工 体检 打架 违规 新居民 访客 吴大哥 赵大姐 卖菜大姐 老吴 吴春飞 手镯 镯子 布艺 生意 嘉宾 捐款 虐恋 恋爱 水电费 水费 电费 争执 老吴 吴哥 一日游 访客 账本 收入 甩臀舞 解锁 帐篷 蚊帐 画画 画像 退订单 退单 礼物 生日 作画 素描 鸭 拍卖 偷吃 包子 肉包 新人 新居民 发泄 画作 争吵 父母 来访 实干 减肥 作秀 推介会 拍卖 天价 打造 梦想 新家园 项目 舞台 演唱会 背后 借刀杀人 违规 出局 造谣 诬陷 严惩 走 离开 退出 投资 离去 撕 吵架 大战 画像 悬疑 草 演唱 乐队 音乐 淘汰区 录音 内幕 儿童 派对 炮轰 撕逼 告别 娃娃 萌娃 健身 月饼 IT哥 甩臀舞 礼物 鸭舌 鸭棚 建材 老板 打拳 裸睡 游戏 你行你上 开放日 方案 点歌 广告 屏满 刷屏 定金 退画 采购)
  #我们15个娱乐关键词
  ...
  #我们15个人物关键词
  KWS = {
    "肖凡凡" => %w(肖凡凡 凡凡 云南妹 黑妹 洗头妹 骚浪贱 学生妹),
    "刘洛汐" => %w(刘落夕 心机婊 心机妹 汐哥 平胸妹 心机表),
    "刘希"   => %w(刘希 刘西 刘熙),
    "聂江伟" => %w(聂江伟 老鬼 队长 鬼哥),
    "张婷媗" => %w(张婷媗 台湾 辣妈 台妹 台独女),
    "邓碧莹" => %w(邓碧莹 短发女 广东妹 逗比莹 逗逼莹 必赢),
    "孙铭"   => %w(孙铭 兵哥),
    "郭道辉" => %w(郭道辉 农民工),
    "刘志轩" => %w(刘志轩 蘑菇头 锅盖头 黑衣男 小四眼 小黑哥 马桶),
    "易秋"  => %w(易秋 道士 易大师 易狗 一球 赵家平),
    "宋鸽"  => %w(宋鸽 鸽子 博士 哈佛女),
    "丘子建" => %w(丘子建 渣男 拳手),
    "谭丽敏" => %w(谭丽敏 老太太 老太婆 上海阿姨 老奶奶 老阿姨 谭阿姨),
    "郑虎"  => %w(郑虎 胖子 胖胖 胖虎),
    "刘富华" => %w(刘富华 鲁迅 老刘),
    "韦泽华" => %w(韦泽华 小宝 韦爵爷 韦哥 小韦 伪宝 萎宝 某宝),
    "陈宪一" => %w(陈宪一 宪一 汉奸一) ,
    "张杰" => %w(张杰 杰哥 奸人张 Z杰 脏杰),
    "魏敏" => %w(魏敏 花姨 花姐 魏姐 魏阿姨 花姑 慧儿姐 花阿姨 花姐姐 花妈 魏大姐),
    "高峰" => %w(高峰 高峰姐),
    "陈常春" => %w(陈常春 春人 春娘 春姐 春春 龅牙春),
    "吴春飞" => %w(吴春飞 老吴 吴大哈 吴大哥),
    "吕日阳" => %w(日阳 小吕 吕秀才),
    "丁囡" => %w(丁囡 丁美人 丁丁 花瓶 模特 龅牙妹 丁表 丁妹 丁美女),
    "訾鹏" => %w(訾鹏 画家),
    "田彬子" => %w(彬子 彬哥 田二 田500)
  }
  ...
  #完美假期预警关键词
  WARN4 = %w(醉了 无语 不看 看不懂 慢 加载 负能量 禁播 无聊 不公平 水军 不精彩 不严厉 网速 抄袭 失望 自吹自擂 黑屏 骗 坑人 切换镜头 规则不严)
  #完美假期卷入关键词
  ENTANGLE4 = %w(淘汰 投 票 心计 直播 心机 奉献 和谐 818 能量 公平 人性 撕 赛制 规则 客房 生活 宫心)

  # 完美假期人物关键词
  KWS3 = {
    "许晓诺" => %w(许晓诺 屎诺 诺诺 许 小诺 晓诺 诺哥 诺粉 诺小兔),  
    "张思帆" => %w(张思帆 张大帅哥 帆 思凡 小帆),
    "朱可儿" => %w(朱可儿 小可),
    "鸡排哥" => %w(鸡排哥 J排哥 鸡排),
    "曾嘉琪" => %w(曾嘉琪 嘉琪 德国 加琪 混血 心机婊 琪琪),
    "金用训" => %w(金用训 欧巴 韩国),
    "翁炜炜" => %w(翁炜炜 炜炜 心理师),
    "Jason" => %w(Jason Seven),
    "王濛"   => %w(王濛 王蒙),
